...
class VideoPlayer {
  constructor(triggers, overlay) {
    ...
    this.onPlayerStatecChange = this.onPlayerStatecChange.bind(this);
  }
  bindTriggers() {
    this.btns.forEach((btn, i) => {
      try {
  ...
  createPlayer(url) {
    this.player = new YT.Player('frame', {
      ...
      videoId: `${url}`,
      events: {
        'onStateChange': this.onPlayerStatecChange
      }
    });
  }
  onPlayerStatecChange(state) {
    try {
...
class MainSlider extends _slider__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  showSlides(n) {
    ...
    for (let i = 0; i < this.slides.length; i++) {
      ...
      this.slides[i].classList.remove('animated', 'slideInDown');
    }
...
/* harmony import */ var _modules_donwload__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/donwload */ "./src/js/modules/donwload.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  showUpSlider.init();
  const moduleSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  new _modules_donwload__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').init();
});
})();
